...
export const IndexToolCard = ({
  ...
  return (
    <div className="w-full min-h-fit lg:h-72 shadow-2xl rounded-2xl bg-gradient-to-br from-slate-50 to-slate-200 dark:from-slate-800 dark:to-slate-900 py-5 px-3 text-center flex flex-col justify-center">
      ...
      <div className="text-gray-600 dark:text-gray-400 mt-5">
        <p>{desc}</p>
      </div>
      <div className="mt-11 flex flex-col lg:flex-row items-center gap-0 lg:gap-4 justify-center">
        <Link
          className="text-secondary dark:text-primary underline underline-offset-8 flex gap-2 items-center"
          href={href}
        >
          {link}
          <GoArrowLeft />
...
export const CTA = () => {
  return (
    <div className="h-fit py-5 px-5 lg:px-32 text-center w-full mt-20">
      <div className="rounded-2xl shadow-2xl bg-gradient-to-br bg-grad from-cyan-700 to-purple-700 py-10">
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-around gap-4 lg:gap-20 text-slate-200 mt-8">
